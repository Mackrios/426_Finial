...
architecture rtl of instruction_memory is
  ...
  -- ===========================================================
  -- PROGRAM MATCHING ASSEMBLY CODE
  -- ===========================================================
  -- Register assignment:
  -- r0 = v0    (0x0040)
  -- r1 = v1    (0x1010)
...
--  signal mem : mem_array := (
--    -- 0x00: lw r1, 0(r0)   (load into r1)
--    -- I-Format: [0001][000][001][000000]
--    0  => x"1040",

--    -- 0x02: sub r0, r1, r0 (uses loaded r1 immediately ? load-use hazard)
--    -- R-Format: [0000][001][000][000][001]
--    1  => x"0201",

--    -- 0x04: nop (all zeros treated as harmless R-type)
--    2  => x"0000",
